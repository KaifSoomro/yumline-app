...
const RecipeCardComp = ({ values }) => {
  return (
    <div className='relative w-[300px] h-[300px] hover:scale-103 cursor-pointer transition-all mx-auto flex flex-col bg-gradient-to-t from-cyan-100 to-transparent rounded-2xl mt-10 p-2 overflow-hidden'>
