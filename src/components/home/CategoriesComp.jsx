  ...
  return (
    <>
        <div className='w-full flex items-center justify-between px-5 md:px-50'>
            ...
            <button className='md:px-5 md:py-2 px-3 py-1 bg-neutral-300 text-neutral-800 hover:bg-neutral-400 md:text-lg font-semibold rounded mt-5 cursor-pointer'>View All</button>
        </div>
...

        {
            categoriesData && categoriesData.map((value) => (
                <div className={`w-full md:w-[150px] md:h-[180px] cursor-pointer rounded-md group flex items-center flex-col justify-center bg-gradient-to-t ${value.color} to-transparent`}>
